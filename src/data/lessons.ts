// This module provides lesson data parsed from content/lessons/*.md frontmatter.
// In a full SSG build, content-collections would generate this automatically.
// For the Lovable dev environment, we define lesson data directly here.
...
export const allLessons: LessonData[] = [
  {
    ...
    whyItMatters: `Gemini is Google's family of multimodal AI models. If you plan to build modern developer tools, automations, copilots, or agent-style workflows, you need to understand what Gemini is good at and where it fits in practice.
...
**Correct answer:** 2`,
    ...
    additionalInfo: `## Additional perspective
